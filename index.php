...
<body id="page-top">
                        ...
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                <div class="pass">
                                    ...
                                    <i class="fas fa-eye-slash passIcon" id="logPassIcon"></i>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                <div class="pass">
                                    ...
                                    <i class="fas fa-eye-slash passIcon" id="regPassIcon"></i>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                <div class="pass">
                                    ...
                                    <input name="register-re-password" class="form-control" id="register-re-password" type="password" placeholder="Re-type Password" required="required" data-validation-required-message="Please re-enter your password">
                                    <i class="fas fa-eye-slash passIcon" id="regRePassIcon"></i>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        jQuery('#logPassIcon').click(function() {
            var elementType = jQuery('#login-password').attr('type');
            console.log(elementType);
            if (elementType == "text") {
                jQuery('#login-password').attr('type', 'password');
                jQuery('#logPassIcon').removeClass('fa-eye');
                jQuery('#logPassIcon').addClass('fa-eye-slash');
            } else if (elementType == "password") {
                jQuery('#login-password').attr('type', 'text');
                jQuery('#logPassIcon').removeClass('fa-eye-slash');
                jQuery('#logPassIcon').addClass('fa-eye');
            }
        });

        jQuery('#regPassIcon').click(function() {
            var elementType = jQuery('#register-password').attr('type');
            console.log(elementType);
            if (elementType == "text") {
                jQuery('#register-password').attr('type', 'password');
                jQuery('#regPassIcon').removeClass('fa-eye');
                jQuery('#regPassIcon').addClass('fa-eye-slash');
            } else if (elementType == "password") {
                jQuery('#register-password').attr('type', 'text');
                jQuery('#regPassIcon').removeClass('fa-eye-slash');
                jQuery('#regPassIcon').addClass('fa-eye');
            }
        });

        jQuery('#regRePassIcon').click(function() {
            var elementType = jQuery('#register-re-password').attr('type');
            console.log(elementType);
            if (elementType == "text") {
                jQuery('#register-re-password').attr('type', 'password');
                jQuery('#regRePassIcon').removeClass('fa-eye');
                jQuery('#regRePassIcon').addClass('fa-eye-slash');
            } else if (elementType == "password") {
                jQuery('#register-re-password').attr('type', 'text');
                jQuery('#regRePassIcon').removeClass('fa-eye-slash');
                jQuery('#regRePassIcon').addClass('fa-eye');
            }
        });
    </script>
</body>
